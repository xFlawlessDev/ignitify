...
pub use repositories::{
    ...
    NewDeploymentLog, NewProjectVariable, NewProvider, NewRemoteBuilder, NewRemoteServer,
    NewServerCertificate, NewServiceVariable, NewUptimeMonitor, ProjectActor, ProjectRemoveOutcome,
