...
const props = withDefaults(defineProps<Props>(), {
  ...
  autoScroll: true,
  title: "Terminal",
  copyLabel: "Copy terminal output",
});
...
<template>
  <div
    :class="
      cn('flex flex-col overflow-hidden rounded-lg border bg-zinc-950 text-zinc-100', props.class)
    "
    v-bind="$attrs"
  >
    <slot>
      <TerminalHeader>
        ...
        <div class="flex items-center gap-1">
          <TerminalStatus />
          <TerminalActions>
            <TerminalCopyButton :label="props.copyLabel" />
