            ...
            <dl v-else-if="action === 'config' && details" class="grid gap-3 text-sm">
              ...
              >
                ...
                <dd class="font-mono text-xs">
                  {{ details.config.working_dir || "Image default" }}
                </dd>
              </div>
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div class="min-w-0">
              ...
              <AlertDialogDescription class="mt-2 text-sm leading-5"
                >This will remove
                <span class="font-medium text-foreground">{{ container?.name }}</span> from the
                host. This action cannot be undone.</AlertDialogDescription
              >
            </div>
          </div>
          <p
          ...
          <div class="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
            <AlertDialogCancel as-child>
              <Button class="w-full sm:w-auto" variant="outline" :disabled="removing"
                >Cancel</Button
              >
            </AlertDialogCancel>
